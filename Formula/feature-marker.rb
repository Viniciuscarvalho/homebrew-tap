...
class FeatureMarker < Formula
  ...
  url "https://github.com/Viniciuscarvalho/Feature-marker/archive/refs/tags/v4.0.0.tar.gz"
  sha256 "PLACEHOLDER_SHA256" # Update this with actual SHA256 after release
  license "MIT"
